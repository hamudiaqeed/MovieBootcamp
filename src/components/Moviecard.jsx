...
function Moviecard({ movie }) {
    const { user, bookmarkClicked, setBookmarkClicked } = useContext(Contextpage);
    ...
    return (
        <motion.div
            ...
            exit={{ opacity: 1 }}
            layout
            className="card relative w-full md:w-60 h-[410px] md:h-[360px] my-3 mx-4 md:my-5 md:mx-0 cursor-pointer rounded-xl overflow-hidden shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)]">
